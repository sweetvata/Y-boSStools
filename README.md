...
WPF-лаунчер для скриншеера. Скачивает форензик-тулзы, запускает PowerShell-скрипты, открывает ссылки — всё в одном окне
...
Короче оно скрипты обфусцирует и фигачит но все они чистые вы можете чекнуть в моем .ps1 оригиналы, а там их чек
